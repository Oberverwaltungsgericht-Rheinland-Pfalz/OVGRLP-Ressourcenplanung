...
IF @var3 IS NOT NULL EXEC(N'ALTER TABLE [Gadgets] DROP CONSTRAINT [' + @var3 + '];');
...
ALTER TABLE [Allocations] ADD [ScheduleSeriesGuid] uniqueidentifier NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200225092147_scheduleSeries_added', N'3.1.0');
...
IF @var4 IS NOT NULL EXEC(N'ALTER TABLE [SupplierGroups] DROP CONSTRAINT [' + @var4 + '];');
